...
export const projects: Project[] = [
  {
    ...
    description: "An immersive space club dashboard under development featuring an event calendar, official space agency missions, discovery timeline, and interactive member directory. Releasing in 3 months.",
    ...
    status: "development",
    details: [
      "Target Release: October 2026 (In about 3 months)",
  ...
  },
  {
    ...
    description: "A space visualization tool facilitating ISS pass prediction across cities, James Webb Space Telescope explorer, Asteroid tracking, and Astronomy Picture of the Day educational content. Releasing in 3 months.",
  ...
  },
  {
    id: "entropy",
    title: "Entropy",
    description: "A community platform hosting hackathons, issuing automated virtual certificates, sharing famous scientist papers, self-paced teaching workshops, and streak-based badges. Releasing in 3 months.",
